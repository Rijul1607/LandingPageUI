...
export const Testimonials = () => {
  return <section className="py-20 md:py-24">
    <div className="container">
      <h2 className="text-5xl md:6xl text-center tracking-tighter font-medium">Beyond Expectations</h2>
      ...
      <motion.div initial={{translateX:'-50%'}} animate={{translateX:'0'}} transition={{repeat:Infinity , ease:"linear" ,duration:30}} className="flex gap-5 pr-5 flex-none ">
