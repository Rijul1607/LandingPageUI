...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      className="absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] border border-white/20 rounded-full opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      className="absolute h-[444px] w-[444px] md:h-[700px] md:w-[700px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"></motion.div>
      {/* end ring2 */}
      {/* start ring 3 */}
      <motion.div
      style={{
      ...
      <div className="container relative mt-16">
        ...
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          Elevate your site's visibility effirtlessly with AI, where smart
